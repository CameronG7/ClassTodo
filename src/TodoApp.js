...
// in functional components we cannot create sideeffects
// sideeffects are anything that affects anything outside of the function like changing the DOM, making an API call, etc.
// in order to create sideeffects we need to use hooks
